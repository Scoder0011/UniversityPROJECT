# auth.py  (or paste into top of your existing app.py)
import os
...
users_coll = db["users"]
history_coll = db["history"]  # optional: store combine events
...
def register_auth_routes(app: Flask):
    ...
    # helper to store combine history
    ...
    # Example: you can call record_history(...) inside your /combine route
